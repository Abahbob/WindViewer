...
namespace WWActorEdit.Kazari.DZx
{
    public class SHIP : IDZxChunkElement
    {
        ...
        public SHIP(RARC.FileEntry FE, ref int SrcOffset, TreeNode ParentNode, System.Drawing.Color Color = default(System.Drawing.Color), ZeldaArc ParentZA = null)
        {
            ParentFile = FE;
        ...
        public void StoreChanges()
        {
            ...
            Helpers.Overwrite32(ref Data, Offset, BitConverter.ToUInt32(BitConverter.GetBytes(_Position.X + ZA.Translation.X), 0));
            Helpers.Overwrite32(ref Data, Offset + 0x04, BitConverter.ToUInt32(BitConverter.GetBytes(_Position.Y + ZA.Translation.Y), 0));
            Helpers.Overwrite32(ref Data, Offset + 0x08, BitConverter.ToUInt32(BitConverter.GetBytes(_Position.Z + ZA.Translation.Z), 0));
